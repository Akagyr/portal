import EmptyBlock from '@/app/components/main/EmptyBlock';
...
export default async function QuestionsPage({
  ...
  const questions = (await getQuestionsByTestId(searchParams.testsId)) as Question[];

  if (!questions || questions.length === 0) {
    return <EmptyBlock text='Питання поки що відсутні' />;
  }
  ...
  return (
    <>
      <div className='mb-[30px]'>
        <Link
          href={`/quiz?testsId=${searchParams.testsId}`}
